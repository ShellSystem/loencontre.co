		   						...
		   						<div class="panel-body carrusel">
		   							...
		   							<div class="col-xs-11 col-xs-offset-1">
										<h3 class="titulo_carrusel">
											<a href="{{$servicios[$i]->ruta}}" class="titulo_carrusel">{{$servicios[$i]->nombre}}</a>
										</h3>
									</div>
					...
					<div class="col-md-5 col-xs-11 col-xs-offset-1" >
						<div class="thumbnail thumbnail_ver row" >						
							...
							<div id="{{$articulo['id_articulo']}}" class="scroll caption caption_ver" >
								...
								<div class="col-xs-13" >
									<p id="parrafo_articulo" class="parrafo_articulo">{!!$articulo['resumen']!!}<a href="{{$articulo['ruta']}}" class="btn boton_enviar_articulo enlace_modal">
									... Ver más
								</a></p>
